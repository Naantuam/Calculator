...
//these are actions the calculator can take
...
// Use reducer function to manage all our states
function reducer(state, { type, payload }){
    switch(type) {
        ...
        case ACTIONS.CHOOSE__OPERATION:
        ...
        <div className="calculator-grid">
            <div className="output">
                ...
                <div className="current-operand">
                    ...
                    {/* <input type="number" value={currentOperand} /> */}
                </div>
            </div>
            <button 
            className="span-two" 
